...
internal class MangaMoinsFullVerificationTest {

	@Test
	fun verifyMangaMoinsParserEndToEnd() = runTest(timeout = 6.minutes) {
		val source = MangaParserSource.MANGAMOINS
		...
		println(
			"MANGAMOINS_FULL_SMOKE|updated=${updated.size}|search=${search.size}|manga=${detailed.publicUrl}|" +
